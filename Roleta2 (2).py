...
try:
    def roleta(saldo):
        ...
        while valor_apostado > saldo or (valor_apostado == 0 and valor_apostado < 0):
        ...
        while valor_apostado == saldo:
            ...
            while apostar_saldo != 1 and apostar_saldo != 2:
                apostar_saldo = int(input(
                    "\nEpahh, chato. Tens a certeza de que queres apostar o teu saldo todo??\n\n - Sim (1)\n - Não (2)\n\nR: "))
            if apostar_saldo == 2:
                valor_apostado = float(input("\nQual é o valor que queres apostar?\n\nR: "))
                if valor_apostado > saldo or (valor_apostado == 0 and valor_apostado < 0):
                    print("\nJá estás a brincar mau mau")
                    return
            else:
                break
        ...
        if jogo_roleta == 1:
            ...
            while acima_ou_abaixo != 1 and acima_ou_abaixo != 2:
                acima_ou_abaixo = int(input(
                    "\nOutra vez para ver se entendeste. Pretendes apostar que o número que calha é acima ou abaixo de 25?\n\n - Acima (1)\n - Abaixo (2)\n\nR: "))
        ...
        if jogo_roleta == 2:
            ...
            while vermelho_ou_preto != 1 and vermelho_ou_preto != 2:
                vermelho_ou_preto = int(input(
                    "\nEpahhhh. Outra vez. Pretendes apostar que o número que calha é vermelho ou preto?\n\n - Vermelho (1)\n - Preto (2)\n\nR: "))
        ...
        if jogo_roleta == 3:
            ...
            while numero_certo < 1 or numero_certo > 50:
                numero_certo = int(input("\nAhh seu malandro, acima ou igual a 1 e abaixo ou igual a 50!!\n\nR: "))
        ...
        if saldo <= 0:
            ...
            rov = int(input("\nRodar outra vez??\n\n - Sim (1)\n - Não (2)\n\nR: "))
            while rov != 1 and rov != 2:
                rov = int(input("\nSei que não entendeste, rodar outra vez??\n\n - Sim (1)\n - Não (2)\n\nR: "))
            if rov == 1:
                roleta(saldo)
            elif rov == 2:
