...
try:
    def roleta(saldo):
        ...
        numero_apostado = int(input("\nQual é o número em que queres apostar?\n\nR: "))
        ...
        while valor_apostado == saldo:
            ...
            if apostar_saldo == 2:
                ...
                break
        while numero_apostado > 50 or numero_apostado < 0:
            numero_apostado = int(input("\nNúmero inválido! Qual é o número em que queres apostar?\n\nR: "))
        ...
        if jogo_roleta == 1:
            ...
            if numero_sorteado >= 25:
                if acima_ou_abaixo == 1:
                    ...
                    saldo += valor_ganho
                    print(f"\nBoa!! Calhou acima de 25!! Ganhaste {valor_ganho}$, e ficaste com {saldo}$ de saldo.")
                elif acima_ou_abaixo == 2:
                    print(f"Epahh perdeste, que pena.\n\nO teu saldo ficou em {saldo}$.")
            if numero_sorteado < 25:
                if acima_ou_abaixo == 1:
                    print(f"Epahh perdeste, que pena.\n\nO teu saldo ficou em {saldo}$.")
                elif acima_ou_abaixo == 2:
